...
import { getPublicRoomAmenityName, getPublicRoomId, getPublicRoomNightlyRate } from '../utils/publicRoomFields'
import {
  RoomCardImageArea,
  RoomCardImg,
  RoomCardPlaceholder
      ...
      <Stack>
        <RoomCardImageArea>
          {photoUrl ? (
            ...
            <RoomCardPlaceholder>
              <Typography variant='body2'>{t('hotelRooms.grid.noPhoto', { defaultValue: 'No photo' })}</Typography>
            </RoomCardPlaceholder>
          )}
        </RoomCardImageArea>
          ...
          <Stack spacing={2}>
            ...
            <Stack direction='row' spacing={1} flexWrap='wrap'>
              <Chip
                ...
                label={room.bedType ?? t('hotelPortal.card.bed', { defaultValue: 'Bed' })}
                size='small'
                variant='outlined'
              />
        ...
        <CardActions>
          ...
          >
            {isAvailable
              ? t('hotelPortal.card.viewRoomDetails', { defaultValue: 'View room details' })
              : t('hotelPortal.card.notAvailable', { defaultValue: 'Not available' })}
          </Button>
        </CardActions>
      </Stack>
    </Card>
