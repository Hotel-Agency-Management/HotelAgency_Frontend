          ...
          <Stack spacing={3}>
              ...
              <Stack spacing={1}>
                <Stack direction='row' spacing={1} flexWrap='wrap'>
                  ...
                  <Chip
                    label={
                      hotel.isActive
                        ? t('hotelPortal.details.availableNow', { defaultValue: 'Available now' })
            ...
            >
              ...
              <Stack direction='row' spacing={1} alignItems='center'>
                ...
                <Typography>
                  {t('hotelPortal.details.ratingReviews', {
                    rating: hotel.rating,
                    reviews: formatReviewCount(hotel.reviews),
                    defaultValue: '{{rating}} rating · {{reviews}} reviews'
                  })}
                </Typography>
              </Stack>
            </Stack>
            ...
            <Box>
              ...
              >
                {t('hotelPortal.details.viewRooms', { defaultValue: 'View available rooms' })}
              </Button>
            </Box>
          </Stack>
        )}
