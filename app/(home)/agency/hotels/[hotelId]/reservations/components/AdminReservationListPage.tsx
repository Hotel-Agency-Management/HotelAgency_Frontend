        ...
        >
          <Stack gap={0.75}>
            <Typography variant='h5' fontWeight={700}>
              {t('adminReservations.title', { defaultValue: 'Reservations' })}
            </Typography>
          </Stack>
          ...
          >
            {t('adminReservations.create', { defaultValue: 'Create Reservation' })}
          </Button>
        </Stack>
        ...
        <Paper variant='card'>
          <Stack gap={themeConfig.common.commonSpacing}>
            ...
            >
              <Stack gap={0.5}>
                <Typography variant='subtitle1' fontWeight={700}>
                  {t('adminReservations.allReservations', { defaultValue: 'All Reservations' })}
                </Typography>
                <Typography variant='body2'>
                  {t('adminReservations.viewManage', { defaultValue: 'View and manage guest reservations.' })}
                </Typography>
              </Stack>
              ...
              <Stack direction={{ xs: 'column', sm: 'row' }} gap={1.5}>
                <SearchInput
                  value={search}
                  placeholder={t('adminReservations.search', { defaultValue: 'Search by guest name…' })}
                ...
                >
                  <MenuItem value=''>
                    {t('adminReservations.filters.allStatuses', { defaultValue: 'All Statuses' })}
                  </MenuItem>
            ...
            <DataGrid
              ...
              onRowClick={({ row }) => router.push(`${reservationsBasePath}/${row.id}`)}
