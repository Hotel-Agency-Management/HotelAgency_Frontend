...
export const getRoomGridColumns = (
  ...
  return [
    {
      field: "roomNumber",
      headerName: t("hotelRooms.grid.roomNumber", "Room #"),
      flex: 0.8,
      minWidth: 80,
    },
    {
      field: "capacity",
      headerName: t("hotelRooms.grid.capacity", "Capacity"),
      flex: 0.6,
      minWidth: 70,
    },
    {
      field: "roomType",
      headerName: t("hotelRooms.grid.type", "Type"),
      flex: 1,
      minWidth: 120,
    },
    {
      field: "status",
      headerName: t("hotelRooms.grid.status", "Status"),
      flex: 1.2,
      minWidth: 120,
    ...
    {
      field: "actions",
      headerName: t("hotelRooms.grid.actions", "Actions"),
      flex: 0.8,
      minWidth: 90,
      sortable: false,
      renderCell: (params) => (
