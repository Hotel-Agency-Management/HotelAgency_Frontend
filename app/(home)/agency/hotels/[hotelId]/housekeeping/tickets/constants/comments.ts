...
export function getCommentActionTypeConfig(
  ...
  return {
    [TICKET_COMMENT_ACTION_TYPE.FEEDBACK]: {
      label: t("housekeeping.tickets.comments.actionTypes.Feedback", "Feedback"),
      paletteKey: "info",
      icon: "MessageSquare",
    },
    [TICKET_COMMENT_ACTION_TYPE.RESOLVED]: {
      label: t("housekeeping.tickets.comments.actionTypes.Resolved", "Resolved"),
      paletteKey: "success",
      icon: "CheckCircle2",
    },
    [TICKET_COMMENT_ACTION_TYPE.DAMAGE_REPORTED]: {
      label: t("housekeeping.tickets.comments.actionTypes.DamageReported", "Damage Reported"),
      paletteKey: "error",
      icon: "AlertTriangle",
    },
  };
...
export function getCommentQuickActions(t: TFunction) {
  return [
    { label: t("housekeeping.tickets.comments.quickActions.looksGood", "Looks good!"), text: "Looks good! ✅" },
    { label: t("housekeeping.tickets.comments.quickActions.needHelp", "Need help?"), text: "Need help? 👋" },
    { label: t("housekeeping.tickets.comments.quickActions.isBlocked", "This is blocked..."), text: "This is blocked 🛑" },
  ];
}
