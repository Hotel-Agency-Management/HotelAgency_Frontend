  ...
  return (
    <Stack spacing={1} alignItems='center' justifyContent='center' height='100%'>
      ...
      <Typography variant='caption' color='text.disabled'>
        {t('agencyHotels.coverImage.clickToUpload', { defaultValue: 'Click to upload cover image' })}
      </Typography>
      <Typography variant='caption' color='text.disabled' sx={{ fontSize: '0.6rem' }}>
        {t('agencyHotels.coverImage.fileTypes', { defaultValue: 'PNG, JPG, WEBP · max 5 MB' })}
      </Typography>
    </Stack>
  )
}
