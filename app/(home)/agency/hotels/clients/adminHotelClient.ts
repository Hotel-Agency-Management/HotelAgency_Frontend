...
export const adminGetHotels = async (agencyId: number): Promise<HotelResponse[]> => {
  const response = await apiClient.get<HotelResponse[]>(`/admin/agencies/${agencyId}/hotels`)
  return response.data
}
