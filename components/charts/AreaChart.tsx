...
/**
 * Area chart — lines with a filled region below each series.
 *
...
export default function AreaChart({
  ...
  const calculatedPercentages = percentage && !percentageData ? calculateMultiSeriesPercentages(rawMatrix) : undefined
